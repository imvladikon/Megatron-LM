    ...
    def forward(
        ...
        *,
        ...
        Args:
            ...
            output_processor: Optional caller-owned projection/loss function. Runs
                only on post-process stages, after the decoder and optional MTP loss.
                When provided, its result replaces the default logits/loss output.
            output_processor_context: Opaque context passed to output_processor.
        """
